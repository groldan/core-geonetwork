 ...
 * {@code org.fao.geonet.events.history.RecordOwnerChangeEvent} event to the
 * event bus.
 */
@Data
@EqualsAndHashCode(callSuper = true)
public class RecordOwnerChangeRemoteEvent extends AbstractHistoryRemoteEvent {

    public static final String FIELD = "owner";

    private static final long serialVersionUID = -1969470377634645341L;

    private Object oldOwnerObjectJSON, newOwnerObjectJSON;

    // REVISIT: why is JSONObject being used as event payload?
    public RecordOwnerChangeRemoteEvent(Object source, String originService, Integer mdId, Integer userId, //
