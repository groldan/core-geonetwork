 ...
 * {@code org.fao.geonet.events.history.RecordProcessingChangeEvent} event to
 * the event bus.
 */
@Data
@EqualsAndHashCode(callSuper = true)
public class RecordProcessingChangeRemoteEvent extends AbstractHistoryRemoteEvent {
    ...
    public RecordProcessingChangeRemoteEvent(Object source, String originService, Integer mdId, Integer userId,
            String xmlRecordBefore, String xmlRecordAfter, String process) {
