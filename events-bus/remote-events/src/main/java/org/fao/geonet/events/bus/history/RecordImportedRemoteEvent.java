 ...
 * {@code org.fao.geonet.events.history.RecordImportedEvent} event to the event
 * bus.
 */
@Data
@EqualsAndHashCode(callSuper = true)
public class RecordImportedRemoteEvent extends AbstractHistoryRemoteEvent {
    ...
    public RecordImportedRemoteEvent(Object source, String originService, Integer mdId, Integer userId, //
