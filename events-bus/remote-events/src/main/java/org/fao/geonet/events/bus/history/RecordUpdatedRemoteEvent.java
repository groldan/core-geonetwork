 ...
 * {@code org.fao.geonet.events.history.RecordUpdatedEvent} event to the event
 * bus.
 */
@Data
@EqualsAndHashCode(callSuper = true)
public class RecordUpdatedRemoteEvent extends AbstractHistoryRemoteEvent {

    private static final long serialVersionUID = 1110999025730522535L;

    private String xmlRecordBefore, xmlRecordAfter;

    public RecordUpdatedRemoteEvent(Object source, String originService, Integer mdId, Integer userId,
            String xmlRecordBefore, String xmlRecordAfter) {
