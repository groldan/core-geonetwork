 ...
 * {@code org.fao.geonet.events.history.RecordDeletedRemoteEvent} event to the
 * event bus.
 */
@Data
@EqualsAndHashCode(callSuper = true)
public class RecordDeletedRemoteEvent extends AbstractHistoryRemoteEvent {

    private static final long serialVersionUID = 1110999025730522535L;

    private String xmlRecord;

    public RecordDeletedRemoteEvent(Object source, String originService, Integer mdId, Integer userId,
            String xmlRecord) {
